        ...
        <div class="container">
            ...
            <div class="left">
                ...
                <div class="sidebar">
                    ...
                    <a class="menu-item" href="explore.php"><span><i class="uil uil-compass"></i></span>
                        <h3>Explore</h3>
                    </a>
                    <a class="menu-item" id="notifications"><span><i class="uil uil-bell"><small class="notifications-count">o</small></i></span>
                        <h3>Notifications</h3>
                    </a>
                    <!-----------------------------------------------  POP-UP ------------------->
                    <?php
                ...
                <div class="feeds">
                    ...
                    <div class="feed">
                        ...
                        <div class="liked-by">
                            ...
                            <span><img src="profile-13.jpg" alt="" /></span>
                            <p>Liked by <b>Ali</b> and <b><?php echo $row['likes'] ?></b> others</p>
                        </div>
                        <div class="caption">
                            <p><b> <?php echo $row['fullname'] ?></b> <?php echo $row['caption'] ?></p>
                        </div>
                    ...
                    <div class="feed">
                        ...
                        <div class="liked-by">
                            <span>
                                <img src="profile-10.jpg" alt="" />
                            </span>
                            <span><img src="profile-5.jpg" alt="" />
                            </span>
                            <span><img src="profile-7.jpg" alt="" /></span>
                            <p>Liked by <b>Smack</b> and <b><?php echo $row['likes'] ?> </b> others</p>
                        </div>
                        <div class="caption">
                            <p><b> <?php echo $row['fullname'] ?></b> <?php echo $row['caption'] ?></p>
                        </div>
                    ...
                    <div class="feed">
                        ...
                        <div class="liked-by">
                            ...
                            <span><img src="profile-8.jpg" alt="" />
                            </span>
                            <span><img src="profile-2.jpg" alt="" /></span>
                            <p>Liked by <b>Babba</b> and <b><?php echo $row['likes'] ?> others</b></p>
                        </div>
                        <div class="caption">
                            <p><b> <?php echo $row['fullname'] ?></b> <?php echo $row['caption'] ?></p>
                        </div>
                    ...
                    <div class="feed">
                        ...
                        <div class="liked-by">
                            ...
                            <span><img src="profile-3.jpg" alt="" />
                            </span>
                            <span><img src="profile-4.jpg" alt="" /></span>
                            <p>Liked by <b>Moti</b> and <b><?php echo $row['likes'] ?></b> others</p>
                        </div>
                        <div class="caption">
                            <p><b> <?php echo $row['fullname'] ?></b><?php echo $row['caption'] ?> </p>
                        </div>
