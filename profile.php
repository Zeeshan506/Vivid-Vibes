...
$subtask4 = mysqli_query($conn, $sql4);
$task5 = mysqli_query($conn, $sql5);
$task6 = mysqli_query($conn, $sql6);
$task7 = mysqli_query($conn, $sql7);
$subtask2 = mysqli_query($conn, $sql2);
$task8 = mysqli_query($conn, $sql8);
$subtask1 = mysqli_query($conn, $sql1);
// $task7 = mysqli_query($conn,$sql7);
...
<body>
  <nav>
    <div class="container">
      ...
      <div class="search-bar">
        ...
        <input type="search" placeholder="Search For Influencesors and Creators <?php echo $user_id ?>" />
      </div>
      <div class="create">
  ...
  <main>
    <div class="container">
      ...
      <!-------------------- ------------------------------     Profile Card -------------------->
      <?php
      $row = mysqli_fetch_assoc($task7);
      ?>

      <div class="middle">
        <div class="profile-card">
          <div class="profile-photo-profile">
            <img src="<?php echo $row['picture'] ?>" alt=""><br>
          </div>
          <?php
          $row = mysqli_fetch_assoc($subtask1);
          ?>
        ...
        <?php
        $row = mysqli_fetch_assoc($subtask2);
        ?>
        <!-- ------------------------- FEEDS------------------------- -->
        <div class="feeds">
          <!-- ------------------------- Feed 1----------------- -->
          <?php
          $row = mysqli_fetch_assoc($subtask4);
          ?>
          <div class="feed">
            <div class="head">
              <div class="user">
